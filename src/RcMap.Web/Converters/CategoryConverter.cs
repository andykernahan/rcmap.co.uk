...
{
    /// <summary>
    /// Provides support for converting <see cref="RcMap.Model.Category"/>s into thier
    /// equivalent JavaScript Object Notation representation. This class cannot be inherited.
    /// </summary>
    [Serializable]
    public sealed class CategoryConverter : JsonConverter
    {
        ...
        public override IJsonType Convert(object obj, IJsonSerializer serializer) {
            ...
            return Convert((Category)obj, serializer);
        }
        ...
        internal static IJsonType Convert(Category cat, IJsonSerializer serializer) {

            return new JsonNumber(cat.Id);
        }
        ...
        private static readonly Type TARGET_TYPE = typeof(Category);
