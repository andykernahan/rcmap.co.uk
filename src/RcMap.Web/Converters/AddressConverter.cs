...
{
    /// <summary>
    /// Provides support for converting <see cref="RcMap.Model.Address"/>es into thier
    /// equivalent JavaScript Object Notation representation. This class cannot be inherited.
    /// </summary>
    [Serializable]
    public sealed class AddressConverter : JsonConverter
    {
        ...
        public override IJsonType Convert(object obj, IJsonSerializer serializer) {
            ...
            return Convert((Address)obj, serializer);
        }
        ...
        internal static IJsonType Convert(Address address, IJsonSerializer serializer) {

            JsonObject item = new JsonObject();

            item.Add("Ext", address.Extended);
            item.Add("St", address.Street);
            item.Add("Loc", address.Locality);
            item.Add("Pst", address.Postcode);
            item.Add("Reg", serializer.Serialize(address.Region));
        ...
        private static readonly Type TARGET_TYPE = typeof(Address);
