...
{
    /// <summary>
    /// Provides support for converting <see cref="RcMap.Model.GeoPoint"/>s into thier
    /// equivalent JavaScript Object Notation representation. This class cannot be inherited.
    /// </summary>
    [Serializable]
    public sealed class GeoPointConverter : JsonConverter
    {
        ...
        public override IJsonType Convert(object obj, IJsonSerializer serializer) {
            ...
            return Convert((GeoPoint)obj, serializer);
        }
        ...
        internal static IJsonType Convert(GeoPoint point, IJsonSerializer serializer) {

            JsonObject container = new JsonObject();

            container.Add("Lat", point.Latitude);
            container.Add("Lng", point.Longitude);
        ...
        private static readonly Type TARGET_TYPE = typeof(GeoPoint);
