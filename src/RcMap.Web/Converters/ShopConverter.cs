...
{
    /// <summary>
    /// Provides support for converting <see cref="RcMap.Model.Shop"/>s into thier
    /// equivalent JavaScript Object Notation representation. This class cannot be inherited.
    /// </summary>
    [Serializable]
    public sealed class ShopConverter : JsonConverter
    {
        ...
        public override IJsonType Convert(object obj, IJsonSerializer serializer) {
            ...
            return Convert((Shop)obj, serializer);
        }
        ...
        internal static IJsonType Convert(Shop shop, IJsonSerializer serializer) {

            JsonObject container = LocationConverter.Convert(shop, serializer);

            container.Add("Url", shop.SiteUrl);
            container.Add("Email", shop.Email);
            container.Add("Tel", shop.Telephone);
            container.Add("Fax", shop.Fax);
            container.Add("Cats", serializer.Serialize(shop.Categories));
        ...
        private static readonly Type TARGET_TYPE = typeof(Shop);
