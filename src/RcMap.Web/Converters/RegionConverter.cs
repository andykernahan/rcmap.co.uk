...
{
    /// <summary>
    /// Provides support for converting <see cref="RcMap.Model.Region"/>s into thier
    ...
    public sealed class RegionConverter : JsonConverter
    {
        ...
        public override IJsonType Convert(object obj, IJsonSerializer serializer) {
            ...
            return Convert((Region)obj, serializer);
        }
        ...
        internal static IJsonType Convert(Region region, IJsonSerializer serializer) {

            return new JsonString(region.Name);
        }
        ...
        private static readonly Type TARGET_TYPE = typeof(Region);
