...
{
    /// <summary>
    /// Provides support for converting <see cref="RcMap.Model.Club"/>s into thier
    /// equivalent JavaScript Object Notation representation. This class cannot be inherited.
    /// </summary>
    [Serializable]
    public sealed class ClubConverter : JsonConverter
    {
        ...
        public override IJsonType Convert(object obj, IJsonSerializer serializer) {
            ...
            return Convert((Club)obj, serializer);
        }
        ...
        internal static IJsonType Convert(Club club, IJsonSerializer serializer) {

            JsonObject container = LocationConverter.Convert(club, serializer);

            container.Add("Url", club.SiteUrl);
            container.Add("Cats", serializer.Serialize(club.Categories));            
        ...
        private static readonly Type TARGET_TYPE = typeof(Club);
